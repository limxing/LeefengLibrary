package me.leefeng.imageselector.PhotoView;
    ...
    public void animaTo(Info info, Runnable completeCallBack) {
        if (isInit) {
            ...
            if (info.mWidgetRect.width() < info.mRect.width() || info.mWidgetRect.height() < info.mRect.height()) {
                ...
                final ClipCalculate c = info.mScaleType == ScaleType.FIT_START ? new START() : info
                        .mScaleType == ScaleType.FIT_END ? new END() : new OTHER();
