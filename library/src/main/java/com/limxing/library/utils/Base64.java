 ...
 * Base64 b = new Base64();
 String s = "222222";
 System.out.println(b.encode(s.getBytes()));
 String n = "YXBpcGY=";
 char[] chars = n.toCharArray();
 System.out.println(new String(b.decode(chars)));*/
...
//		// if (args.length < 2) {
//		// System.out.println("usage:  java Base64 [-d|e] string\r\n");
//		// System.exit(-1);
//		// }
//		//
//		// if (args[0].equalsIgnoreCase ("-d")) decode = true;
//		// if (decode) {
//		// System.out.print (new String (decode (args[1].toCharArray())));
//		// } else {
//		// System.out.print (new String (encode (args[1].getBytes ())));
//		// }
//		Base64 b = new Base64();
//		String s = "222222";
//		System.out.println(b.encode(s.getBytes()));
